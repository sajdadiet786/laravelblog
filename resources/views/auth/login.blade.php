                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-3">
                                <a href="" class="btn btn-primary btn-block">Login with google</a>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row ">
                                    ...
                                    <a href="{{route('googleredirect')}}" class="btn btn-danger btn-block col-md-6 offset-md-3">Login with Google</a>
                            ...
                            <div class="form-group row gap-3">
                                    ...
                                    <a href="{{route('redirect')}}" class="btn btn-dark btn-block col-md-6 offset-md-3">Login with Github</a>
